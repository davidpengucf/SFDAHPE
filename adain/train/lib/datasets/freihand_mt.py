...
class FreiHand_mt(Hand21KeypointDataset):
    ...
    def __init__(self, root, split='train', task='all', download=True, k=1, 
        ...
        super(FreiHand_mt, self).__init__(root, samples, **kwargs)
